...
t = True
f = True
test_compute_utility = f
test_minimax_min_node_1 = f
test_minimax_max_node_1 = f
test_minimax_min_node_2 = f
test_minimax_max_node_2 = f

test_alphabeta_min_node_1 = f
test_alphabeta_max_node_1 = f
test_alphabeta_min_node_2 = f
test_alphabeta_max_node_2 = f
test_caching = f
test_ordering = t

test_select_move_minimax = f #
test_select_move_alphabeta = f #
test_select_move_equal = f #
